...
const nomesPorTabela = [
    // Primeira tabela
    ["DENISE DE FÁTIMA C CASTILHO - 425954",
    "HELOISA UBEDA - 427379",
    "ANA JÚLIA CRUZ DE SOUZA - 997828",
    "SARAH LAGE DA FONSECA - 825333"
    ],

    // Segunda tabela
    ["MARCOS PAULO DE SOUZA - 425957",
    "RICARDO ASSAGRA DENIPOTI - 104824",
    "GABRIEL SILVA RODRIGUES - 104798",
    "EDUARDO MEIWA - 427134"
    ],     

    // Terceira tabela
    ["ANGELO ALVES FERREIRA JUNIOR - 998546"],

    // Quarta tabela
    ["LARA MIYUKI DA PAZ OGATA - 998302",
    "AMANDA ALVES DALL' AGNOL - 998527"
    ]
];
...
function gerarTabela(mesAno = null, container = null) {
    ...
    if (dataEscolhidaDiv) {
        dataEscolhidaDiv.textContent = `LABORATÓRIO - UPA OESTE Profº Drº João José Carneiro `<br>`Mês/ano: ${String(mes).padStart(2, '0')}/${ano}`;
    } else {
